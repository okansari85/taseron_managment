...
SONUÇ (result) SÜTUNLARI — ÜÇ FARKLI DURUM VAR, HANGİSİ OLDUĞUNU PDF'DEN AYIRT ET:
...
C) EKİPMAN BAŞINA BİRDEN FAZLA FARKLI KRİTER, HER BİRİ KENDİ AYRI checkbox SÜTUNUNDA — örn. "1- Yangın söndürme cihazları mühürleri..." "2- Yangın söndürme cihazları basınç göstergeleri..." "3- ..." gibi 5-10 arası AYRI sütun, her birinde HER SATIRDA (her ekipman/tüp için) bağımsız bir ✓ işareti var. BU DURUM A'DAN FARKLIDIR: A'da sütunlar aynı SORUNUN 3 farklı CEVABIdır (mutually exclusive), C'de her sütun TAMAMEN FARKLI bir SORUdur ve teorik olarak HEPSİ aynı anda işaretli olabilir. C durumunda bile HER kriter sütunu için AYRI bir "result" girdisi yaz - value SABİT "uygun" olabilir (çünkü işaret o SÜTUNUN kendi kriterinin karşılandığı anlamına gelir, farklı sütunlar arası bir "hangisi seçili" ilişkisi yoktur). header_patterns'a o sütunun GERÇEK, TAM kriter cümlesini yaz (kısaltma, "1- Yangın söndürme cihazları mühürleri" gibi PDF'de göründüğü gibi al). Bu durumu KAÇIRMA: eğer bir tabloda ekipman satırları arasında 5'ten fazla dar, numaralı, kendi soru cümlesi olan sütun görüyorsan bu HEMEN HEMEN HER ZAMAN durum C'dir - onları TEK bir toplu "Değerlendirme"/"Sonuç" sütununa indirgeyip diğerlerini ATLAMA, HEPSİNİ ayrı ayrı columns[] içine ekle. Tablonun sonunda AYRICA tek bir toplu "Değerlendirme" sütunu da varsa (durum B gibi, satırdan satıra değişen), onu da EKLE (aynı equipment için hem C'nin kriter sütunları hem B'nin toplu sütunu BİRLİKTE bulunabilir) - biri diğerinin yerini tutmaz.
