...
CREATE TABLE `companies` (
  ...
  CONSTRAINT `companies_business_entity_id_foreign` FOREIGN KEY (`business_entity_id`) REFERENCES `business_entities` (`id`)
...
CREATE TABLE `location_business_entities` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `lbe_location_business_entity_operational_region_unique` (`location_id`,`business_entity_id`,`operational_region_id`),
  KEY `location_business_entities_business_entity_id_location_id_index` (`business_entity_id`,`location_id`),
  KEY `location_business_entities_operational_unit_id_foreign` (`operational_region_id`),
  KEY `lbe_location_operational_region_index` (`location_id`,`operational_region_id`),
  CONSTRAINT `lbe_operational_region_fk` FOREIGN KEY (`operational_region_id`) REFERENCES `operational_regions` (`id`) ON DELETE SET NULL,
...
--
-- Table structure for table `location_business_entity_brands`
--
...
--
-- Dumping data for table `location_business_entity_brands`
--

LOCK TABLES `location_business_entity_brands` WRITE;
/*!40000 ALTER TABLE `location_business_entity_brands` DISABLE KEYS */;
/*!40000 ALTER TABLE `location_business_entity_brands` ENABLE KEYS */;
UNLOCK TABLES;
